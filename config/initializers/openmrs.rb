...
def setup_openmrs_classpath
  ...
  [ "lib/java/openmrs-api-1.7.0.14010-dev.jar",
    ...
    "lib/java/spring-framework/org.springframework.aop-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.asm-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.beans-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.context-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.context.support-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.core-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.expression-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.jdbc-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.orm-3.0.2.RELEASE.jar",
    "lib/java/lib/spring-framework/org.springframework.test-3.0.2.RELEASE.jar",
    "lib/java/spring-framework/org.springframework.transaction-3.0.2.RELEASE.jar",
